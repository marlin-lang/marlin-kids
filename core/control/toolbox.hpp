  ...
  toolbox() {
    static const auto _default_prototypes{make_array(
        ...
        std::vector{
            ...
            system_procedure_prototype(ast::system_procedure::draw_arc),
            system_procedure_prototype(ast::system_procedure::draw_rect),
            system_procedure_prototype(ast::system_procedure::draw_ellipse),
            system_procedure_prototype(ast::system_procedure::clear_canvas),
            system_procedure_prototype(ast::system_procedure::set_line_width),
            system_procedure_prototype(ast::system_procedure::set_line_color),
            system_procedure_prototype(ast::system_procedure::set_fill_color),
            ...
            system_procedure_prototype(ast::system_procedure::logo_go_home),
        },
        std::vector{bool_literal_prototype(true), bool_literal_prototype(false),
                    binary_prototype(ast::binary_op::add),
        ...
        std::vector{
            new_array_prototype(),
            system_function_prototype(ast::system_function::range1),
            system_function_prototype(ast::system_function::range2),
            system_function_prototype(ast::system_function::range3),
            system_function_prototype(ast::system_function::list_length),
            system_function_prototype(ast::system_function::time),
            system_function_prototype(ast::system_function::random),
            ...
            new_color_prototype(ast::color_mode::hsl),
            new_color_prototype(ast::color_mode::hsla)})};
